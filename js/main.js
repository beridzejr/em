...
;(function(window) {
	...
	Turntable.prototype._play = function(bufferOffset) {
		...
		this.analyserTimeout = setTimeout(function() { self._analyse(); }, bufferOffset && bufferOffset > 0 ? 0 : this.bufferDelay*0);
	...
	Turntable.prototype._createAnalyser = function() {
		...
		// Add border radius to the canvas
	...
	function showExpander(position, callback) {
		dynamics.css(expanderEl, { opacity: 1, left : position.x, top : position.y, backgroundColor : '#0a0a0a', scale : 0 });
